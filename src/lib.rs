...
#[derive(Debug)]
pub struct IconSetProcessor {
    verbose: bool,
    processed_count: usize,
}

impl IconSetProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting IconSet processing");
    
    let mut processor = IconSetProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = IconSetProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = IconSetProcessor::new(false);
